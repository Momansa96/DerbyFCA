export default function Home() {
  return (
    <div className="relative min-h-[calc(100vh-4.5rem)] bg-gradient-to-br from-gray-900 via-indigo-900 to-black overflow-hidden">
      <div
        className="absolute inset-0 z-0 animate-pulse bg-[url('/images/default.jpeg')] opacity-20 bg-cover bg-center bg-no-repeat"
        aria-hidden="true"
      />

      {/* Main content */}
      <div className="relative z-10 flex items-center justify-center h-full px-6 mt-10">
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl shadow-xl p-4 max-w-xl text-center text-white">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-wide text-indigo-400 drop-shadow-[0_0_10px_rgba(99,102,241,0.7)] animate-pulse">
            FCA Derby Manager
          </h1>
          <p className="mt-6 text-base  md:text-lg leading-relaxed text-gray-300">
            Gérez les tirages, consultez les stats de vos coéquipiers et restez à jour sur les matches à venir.
            <br />
